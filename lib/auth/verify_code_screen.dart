...
class _VerifyCodeScreenState extends State<VerifyCodeScreen> {
  ...
  Future<void> verify() async {
    ...
    if (code.length != codeLength) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('أدخل رمز التحقق كاملًا')),
      );
      return;
    }
    ...
    // TODO: استدعاء API تأكيد رمز التحقق هنا — لا تتحققي من الرمز محليًا فقط،
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => ResetPasswordScreen(phone: widget.phone, otp: code),
      ),
    );
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: const TextStyle(color: Color(0xff7D8CA3), fontSize: 11.5, height: 1.6),
              ),
                ...
                children: List.generate(codeLength, (i) {
                  return Container(
                    ...
                    child: TextField(
                      ...
                      style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: Color(0xff123B72)),
              ...
              if (secondsLeft > 0)
                Text(
                  'لم يصلك الرمز؟ إعادة الإرسال خلال 00:${secondsLeft.toString().padLeft(2, '0')}',
                  textAlign: TextAlign.center,
                  style: const TextStyle(color: Color(0xff7D8CA3), fontSize: 11.5),
                )
              else
                Center(
                  child: TextButton(
                    ...
                    child: const Text(
                      'إعادة إرسال الرمز',
                      style: TextStyle(color: Color(0xff0E4595), fontWeight: FontWeight.w700, fontSize: 12),
                    ),
                  ),
                ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: loading
                      ...
                      : const Text('تحقق', style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold)),
                ),
              ),
            ],
          ),
